...
#ifdef DISABLE_GYALIB_SERIALIZE
#include <gyaiolib/serialize.hpp>
#undef GYALIB_SERIALIZE
#define GYALIB_SERIALIZE(...)
#endif
...
struct u128_action {
  ...
  GYALIB_SERIALIZE( u128_action, (values) )
};
...
struct cf_action {
   ...
   GYALIB_SERIALIZE( cf_action, (payload)(cfd_idx) )
};
...
struct dtt_action {
   ...
   GYALIB_SERIALIZE( dtt_action, (payer)(deferred_account)(deferred_action)(permission_name)(delay_sec) )
};
...
struct invalid_access_action {
   ...
   GYALIB_SERIALIZE( invalid_access_action, (code)(val)(index)(store) )
};
