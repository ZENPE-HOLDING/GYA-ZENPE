...
/**
 * @brief GYAIO Public Key
 * @details GYAIO Public Key. It is 34 bytes.
 */
struct public_key {
   char data[34];
};
...
/**
 * @brief GYAIO Signature
 * @details GYAIO Signature. It is 66 bytes.
 */
struct signature {
   uint8_t data[66];
};
...
/**
 * @brief Type of GYAIO Transaction Id
 * @details Type of GYAIO Transaction Id. It is 256-bit hash
 */
