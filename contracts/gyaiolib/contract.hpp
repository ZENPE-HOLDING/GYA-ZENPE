 ...
 * @ingroup types
 * @brief Defines contract type which is %base class for every GYAIO contract
 * 
 * @{
 * 
 */
...
/**
 * @brief %Base class for GYAIO contract.
 * @details %Base class for GYAIO contract. %A new contract should derive from this class, so it can make use of GYAIO_ABI macro.
 */
class contract {
   public:
      /**
