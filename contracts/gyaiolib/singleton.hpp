...
namespace  gyaio {
    ...
    *  @brief Defines GYAIO Singleton Table
    *  @ingroup databasecpp 
    *  @{
    */
   ...
   class singleton
   {
      ...
      struct row {
         ...
         GYALIB_SERIALIZE( row, (value) )
      };

      typedef gyaio::multi_index<SingletonName, row> table;
      ...
      public:
         ...
         T get() {
            ...
            gyaio_assert( itr != _t.end(), "singleton does not exist" );
            return itr->value;
         }
