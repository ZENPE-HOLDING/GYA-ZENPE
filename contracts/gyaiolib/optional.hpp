   ...
   class optional {
      public:
         ...
         */
          ...
          */
         T&       operator*()      { gyaio_assert(_valid, "dereference of empty optional"); return ref(); }
          ...
          * @return T& - Contained value
          */
         const T& operator*()const { gyaio_assert(_valid, "dereference of empty optional"); return ref(); }
         ...
         T*       operator->()
         {
            gyaio_assert(_valid, "dereference of empty optional");
            return ptr();
         }
         ...
         *  @return gyaio::datastream<Stream>& - Reference to the datastream
         */
         template<typename Stream>
         friend inline gyaio::datastream<Stream>& operator>> (gyaio::datastream<Stream>& ds, optional& op)
         {
            char valid = 0;
            ds >> valid;
            if (valid) {
         ...
         */
         template<typename Stream>
         friend inline gyaio::datastream<Stream>& operator<< (gyaio::datastream<Stream>& ds, const optional& op)
         {
