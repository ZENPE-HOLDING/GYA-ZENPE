...
namespace gyaio {
   ...
   struct asset {
      ...
      asset& operator*=( int64_t a ) {
         gyaio_assert( a == 0 || (amount * a) / a == amount, "multiplication overflow or underflow" );
         gyaio_assert( -max_amount <= amount, "multiplication underflow" );
         gyaio_assert( amount <= max_amount,  "multiplication overflow" );
         amount *= a;
         return *this;
      }
