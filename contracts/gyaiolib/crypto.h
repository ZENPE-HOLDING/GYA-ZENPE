 ...
 *  gyaio::print("sha256 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  gyaio::print("sha1 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  gyaio::print("sha512 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  gyaio::print("ripemod160 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  gya_assert( calc_hash == hash, "invalid hash" );
 *  @endcode
 */
 ...
 *  gyaio::print("pub key matches the pub key generated from digest");
 *  @endcode
 */
