...
namespace gyaio {
   ...
   struct margin_state {
      ...
      extended_asset unlend( double ishares ) {
         ...
         gyaio_assert( interest_shares >= 0, "underflow" );
         gyaio_assert( total_lendable.amount >= 0, "underflow" );

         return result;
      }

      GYALIB_SERIALIZE( margin_state, (total_lendable)(total_lent)(least_collateralized)(interest_shares) )
   };
   ...
   struct exchange_state {
      ...
      struct connector {
         ...
         GYALIB_SERIALIZE( connector, (balance)(weight)(peer_margin) )
      };
      ...
      GYALIB_SERIALIZE( exchange_state, (manager)(supply)(fee)(base)(quote) )
   };

   typedef gyaio::multi_index<N(markets), exchange_state> markets;
