...
#include <gyaio/chain/multi_index_includes.hpp>
...
CHAINBASE_SET_INDEX_TYPE(gyaio::chain::table_id_object, gyaio::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(gyaio::chain::key_value_object, gyaio::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(gyaio::chain::index64_object, gyaio::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(gyaio::chain::index128_object, gyaio::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(gyaio::chain::index256_object, gyaio::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(gyaio::chain::index_double_object, gyaio::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(gyaio::chain::index_long_double_object, gyaio::chain::index_long_double_index)

FC_REFLECT(gyaio::chain::table_id_object, (id)(code)(scope)(table) )
FC_REFLECT(gyaio::chain::key_value_object, (id)(t_id)(primary_key)(value)(payer) )
