...
CHAINBASE_SET_INDEX_TYPE(gyaio::chain::permission_link_object, gyaio::chain::permission_link_index)

FC_REFLECT(gyaio::chain::permission_link_object, (id)(account)(code)(message_type)(required_permission))
