...
#include <gyaio/chain/incremental_merkle.hpp>
...
CHAINBASE_SET_INDEX_TYPE(gyaio::chain::global_property_object, gyaio::chain::global_property_multi_index)
CHAINBASE_SET_INDEX_TYPE(gyaio::chain::dynamic_global_property_object,
                         gyaio::chain::dynamic_global_property_multi_index)

FC_REFLECT(gyaio::chain::dynamic_global_property_object,
           (global_action_sequence)
          )

FC_REFLECT(gyaio::chain::global_property_object,
