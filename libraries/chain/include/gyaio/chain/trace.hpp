...
FC_REFLECT( gyaio::chain::base_action_trace,
                    (receipt)(act)(elapsed)(cpu_usage)(console)(total_cpu_usage)(trx_id) )

FC_REFLECT_DERIVED( gyaio::chain::action_trace,
                    (gyaio::chain::base_action_trace), (inline_traces) )

FC_REFLECT( gyaio::chain::transaction_trace, (id)(receipt)(elapsed)(net_usage)(scheduled)
                                             (action_traces)(failed_dtrx_trace)(except) )
FC_REFLECT( gyaio::chain::block_trace, (elapsed)(billed_cpu_usage_us)(trx_traces) )
