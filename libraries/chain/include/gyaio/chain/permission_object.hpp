...
CHAINBASE_SET_INDEX_TYPE(gyaio::chain::permission_object, gyaio::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(gyaio::chain::permission_usage_object, gyaio::chain::permission_usage_index)

FC_REFLECT(chainbase::oid<gyaio::chain::permission_object>, (_id))
FC_REFLECT(gyaio::chain::permission_object, (id)(usage_id)(parent)(owner)(name)(last_updated)(auth))

FC_REFLECT(chainbase::oid<gyaio::chain::permission_usage_object>, (_id))
FC_REFLECT(gyaio::chain::permission_usage_object, (id)(last_used))
