...
FC_REFLECT(gyaio::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(gyaio::chain::key_weight, (key)(weight) )
FC_REFLECT(gyaio::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(gyaio::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(gyaio::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
