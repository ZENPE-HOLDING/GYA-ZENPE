...
//         edump((s->block_num)(s->block->previous)(log_head->id()));
   ...
   void initialize_fork_db() {
      ...
      producer_schedule_type initial_schedule{ 0, {{N(gyaio), conf.genesis.initial_key}} };
   ...
   { try {
      ...
      GYA_ASSERT( gto.delay_until <= self.pending_block_time(), transaction_exception, "this transaction isn't ready",
   ...
   void start_block( block_timestamp_type when, uint16_t confirm_block_count, controller::block_status s ) {
      GYA_ASSERT( !pending, block_validate_exception, "pending block is not available" );
