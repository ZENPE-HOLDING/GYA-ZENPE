...
asset to_asset( const string& code, const string& s ) {
   static map<gyaio::chain::symbol_code, gyaio::chain::symbol> cache;
...
int main( int argc, char** argv ) {
   ...
   getTransaction->set_callback([&] {
      ...
      } GYA_RETHROW_EXCEPTIONS(transaction_id_type_exception, "Invalid transaction ID: ${transaction_id}", ("transaction_id", transaction_id_str))
