...
#include <gyaio/http_client_plugin/http_client_plugin.hpp>
...
FC_REFLECT(gyaio::producer_plugin::runtime_options, (max_transaction_time)(max_irreversible_block_age)(produce_time_offset_us)(last_block_time_offset_us)(subjective_cpu_leeway_us)(incoming_defer_ratio));
FC_REFLECT(gyaio::producer_plugin::greylist_params, (accounts));
FC_REFLECT(gyaio::producer_plugin::whitelist_blacklist, (actor_whitelist)(actor_blacklist)(contract_whitelist)(contract_blacklist)(action_blacklist)(key_blacklist) )
