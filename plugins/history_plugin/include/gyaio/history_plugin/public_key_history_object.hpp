...
CHAINBASE_SET_INDEX_TYPE( gyaio::public_key_history_object, gyaio::public_key_history_multi_index )

FC_REFLECT( gyaio::public_key_history_object, (public_key)(name)(permission) )
