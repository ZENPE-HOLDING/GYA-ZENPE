...
CHAINBASE_SET_INDEX_TYPE( gyaio::account_control_history_object, gyaio::account_control_history_multi_index )

FC_REFLECT( gyaio::account_control_history_object, (controlled_account)(controlled_permission)(controlling_account) )
