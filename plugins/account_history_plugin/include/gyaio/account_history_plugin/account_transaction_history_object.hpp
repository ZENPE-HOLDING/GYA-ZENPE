...
namespace std {
   ...
   template<>
   struct hash<gyaio::chain::account_name>
   {
    size_t operator()( const gyaio::chain::account_name& name )const
    {
...
CHAINBASE_SET_INDEX_TYPE( gyaio::account_transaction_history_object, gyaio::account_transaction_history_multi_index )

FC_REFLECT( gyaio::account_transaction_history_object, (name)(transaction_id) )
