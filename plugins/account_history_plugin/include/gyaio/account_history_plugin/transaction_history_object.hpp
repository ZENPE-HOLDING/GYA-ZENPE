...
CHAINBASE_SET_INDEX_TYPE( gyaio::transaction_history_object, gyaio::transaction_history_multi_index )

FC_REFLECT( gyaio::transaction_history_object, (block_id)(transaction_id)(transaction_status) )
